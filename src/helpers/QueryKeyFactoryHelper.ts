...
export const queryKeys = {
  Location: {
    ...
    contacts: (loc_id: number | undefined) => ['contact_info', 'metadata', loc_id] as const,
  ...
  Timeseries: {
    ...
    allPejling: () => ['measurements', 'register', 'watlevmp'] as const,
    pejling: (ts_id: number | undefined) =>
      ['measurements', 'watlevmp', 'register', ts_id] as const,
    ...
    precipitationData: (ts_id: number) => ['precipitation_data', 'metadata', ts_id] as const,
    linesData: (ts_id: number) => ['lines_data', 'algorithms', 'metadata', ts_id] as const,
